// Addresses on Sepolia (update after deployment)
export const CUSDT_ADDRESS = '0xf0cCe582dce70566431bc250990482d2b3B92f31' as `0x${string}`;
export const BANK_ADDRESS = '0x40ce181F20c34209823352283a02cb2F2f57a00c' as `0x${string}`;

// ABIs copied from deployments (generated) for cUSDT and ZamaBank
// cUSDT relevant subset
